...
if (!hash_equals($config['stats']['username'], $authUser) || !password_verify($authPass, $config['stats']['password'])) {
  ...
  <main>
    ...
    <section>
      ...
      <div class="kpi-grid">
        <div class="kpi c1">
          ...
          <div class="val" id="k-total"><?= number_format($summary->totalHits) ?></div>
        </div>
        <div class="kpi c2">
          <div class="lbl">Hits Hoy</div>
          <div class="val" id="k-today"><?= number_format($summary->hitsToday) ?></div>
        </div>
        <div class="kpi c3">
          <div class="lbl">IPs Únicas Hoy</div>
          <div class="val" id="k-ips"><?= number_format($summary->uniqueIpsToday) ?></div>
        </div>
        <div class="kpi c4">
          <div class="lbl">Orígenes Únicos</div>
          <div class="val" id="k-domains"><?= number_format($summary->uniqueReferers) ?></div>
        </div>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="grid3">
        <div class="card">
          <h3>Top Dominios</h3>
          <div id="tblDomains" class="loading">Cargando…</div>
        </div>
        <div class="card">
          <h3>Top Apps</h3>
          <div id="tblApps" class="loading">Cargando…</div>
        </div>
        <div class="card">
          <h3>Top Países</h3>
          <div id="tblCountries" class="loading">Cargando…</div>
        </div>
      </div>
    </section>
    ...
    <section>
      ...
      <div class="card full">
        <div id="tblRecent" class="loading">Cargando…</div>
      </div>
    </section>
